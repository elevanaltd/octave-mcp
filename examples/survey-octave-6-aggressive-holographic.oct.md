...
VERSION::SEMANTIC["6.0", ANCHOR::"octave://spec/research"]
  ...
  CONTRACT::HOLOGRAPHIC[
    ...
    GENERATIVE_CONSTRAINT::GRAMMAR_COMPILE[
      ...
      SECTION::SCHEMA_LANGUAGES REQUIRED::true
      SECTION::UNIFIED_LANGUAGES REQUIRED::true
      SECTION::CODE_LIBRARIES REQUIRED::true
      SECTION::GRAMMARS_EXECUTABLE REQUIRED::true
      SECTION::LLM_STRUCTURED_OUTPUT REQUIRED::true
      SECTION::COMPARATIVE_MATRIX REQUIRED::true
      SECTION::NOVELTY REQUIRED::true
