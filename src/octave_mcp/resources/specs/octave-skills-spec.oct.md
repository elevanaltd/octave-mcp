...
META:
  ...
  CONTRACT::SKILL_DEFINITION[
    PRINCIPLE::"Skills use OCTAVE for definition. YAML frontmatter is OPTIONAL for platform discovery.",
    MECHANISM::[YAML_FRONTMATTER[OPTIONAL], OCTAVE_ENVELOPE[META, BODY, §5::ANCHOR_KERNEL]],
...
SEQUENCE::[OCTAVE_ENVELOPE, "§5::ANCHOR_KERNEL"]
YAML_FRONTMATTER::OPTIONAL[required_for_platform_deployment]
YAML_FIELDS::[name, description, "allowed-tools", triggers, version]
...
V7_COMPAT::[
  ...
  REQUIRED_V7::[octave_envelope, anchor_kernel_recommended, no_markdown_headers, description_role_retrieval_only]
]
